...
final class FeedLocalizationTests: XCTestCase {
    ...
    private func allLocalizedStringKeys(in localizedBundles: [LocalizedBundle], table: String, file: StaticString = #file, line: UInt = #line) -> Set<String> {
        localizedBundles.reduce([]) { result, current in
